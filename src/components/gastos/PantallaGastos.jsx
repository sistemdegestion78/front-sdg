    ...
    <div className="mx-auto w-full max-w-3xl px-3 py-4 sm:px-6 sm:py-8">
      ...
      <div className="mb-6 overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
        <div className="border-b border-slate-100 bg-slate-50/80 px-6 py-3">
          <h2 className="text-xs font-semibold uppercase tracking-wider text-slate-400">Datos del viaje</h2>
        </div>
        <div className="grid grid-cols-1 gap-x-8 gap-y-4 px-4 py-4 sm:grid-cols-2 sm:px-6 sm:py-5">
          <div className="flex flex-col gap-0.5">
            <span className="text-xs font-medium text-slate-400">Empresa transportadora</span>
            <span className="text-sm font-semibold text-slate-800">{viaje.empresa || empresaTransportadora || '—'}</span>
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-medium text-slate-400">Nº guía</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-medium text-slate-400">Empresa (cliente)</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-medium text-slate-400">Clientes</label>
            <input
              type="text"
      ...
      <div className="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
        <div className="border-b border-slate-100 bg-slate-50/80 px-6 py-3">
          <h2 className="text-xs font-semibold uppercase tracking-wider text-slate-400">Detalle de gastos</h2>
        </div>
          ...
          <div className="mb-4 rounded-xl border border-slate-200 bg-slate-50/50 p-3 sm:p-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-slate-500">Precio/galón</label>
                <input
                  type="text"
                  inputMode="numeric"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-slate-500">Galones</label>
                <input
                  type="text"
                  inputMode="numeric"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-slate-500">Total ACPM</label>
                <input
                  type="text"
                  inputMode="numeric"
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            {GASTOS_CAMPOS.filter(({ key }) => key !== 'acpm').map(({ key, label }) => (
              <div key={key} className="flex flex-col gap-1.5">
                <label className="text-[11px] font-semibold text-slate-500 sm:text-xs">{label}</label>
                <input
                  type="text"
                  inputMode="numeric"
        ...
        <div className="grid grid-cols-3 divide-x divide-slate-100 border-t border-slate-200">
          <div className="px-3 py-3 text-center sm:px-5 sm:py-4">
            <p className="text-[10px] font-semibold uppercase tracking-wider text-slate-400 sm:text-xs">Total gastos</p>
            <p className="mt-1 text-base font-bold text-slate-800 sm:mt-1.5 sm:text-xl">
              {totalGastos.toLocaleString('es-CO')}
            </p>
          </div>
          <div className="px-3 py-3 text-center sm:px-5 sm:py-4">
            <p className="text-[10px] font-semibold uppercase tracking-wider text-slate-400 sm:text-xs">Saldo</p>
          ...
          <div className="px-3 py-3 text-center sm:px-5 sm:py-4">
            <p className="text-[10px] font-semibold uppercase tracking-wider text-slate-400 sm:text-xs">Ganancia</p>
